...
const installPackge = 'ttk-service-template-xxx'


async function serverDownloadMicroserviceTemplate (projectName) {
    console.log('开始创建')
...
export default serverDownloadMicroserviceTemplate